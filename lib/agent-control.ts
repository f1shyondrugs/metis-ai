...
export const METIS_SHARED_AGENT_CONTROL = [
  ...
  "- Graphs: to show interactive plots, write a ```graph JSON fence in chat, notes, plans, or canvas. Do not invent a graph tool. One fence can contain multiple boards. Users can edit the graphs in the UI.",
].join("\n");
