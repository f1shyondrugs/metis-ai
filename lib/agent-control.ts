...
export const METIS_SHARED_AGENT_CONTROL = [
  ...
  "- Graphs: to show interactive plots, write a ```graph JSON fence in chat, notes, plans, or canvas. Do not invent a graph tool. One fence can contain multiple boards. Users can edit the graphs in the UI. Chart-shaped JSON under ```graph is also accepted; the renderer handles it.",
  "- Charts: data viz via a ```chart JSON fence (bar, line, area, pie, donut, scatter) in chat, notes, plans, or canvas. Do not invent a chart tool. One fence can contain multiple charts. Example: {\"type\":\"bar\",\"x\":[\"Jan\",\"Feb\"],\"series\":[{\"name\":\"2025\",\"values\":[12,18]}]}. Users can edit charts in the UI.",
].join("\n");
